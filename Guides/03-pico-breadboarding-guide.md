...
3. In Thonny, create a folder like `~/Desktop/YourName/`.  
...
7. Joining WiFi and finding the Pico’s IP address
8. Hosting a tiny web page with **ON/OFF** buttons
...
6. On a breadboard, which holes are connected together in a **row**, and what does the **center gap** do?  
7. Why is it important that Pico GPIO pins use **3.3 V logic**, and what can go wrong if you connect a 5 V signal directly to a GPIO pin?  
8. **Predict the output:** What will this code do?
...
9. **Debug this button code:** There is a bug that stops the LED from ever turning on. What is wrong, and how would you fix it?
...
10. What is the difference between using a **pushbutton** and using an **ultrasonic sensor** to detect objects? When might you choose one over the other in a project?  
11. Why might you choose to display information on the **OLED** instead of only printing to the **Thonny Shell**? Give one concrete example.
